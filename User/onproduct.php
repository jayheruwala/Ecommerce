...
<main>
    <?php
    $displayDataQuery ="SELECT * FROM $tableName WHERE product_id=$productId";
        ...
        <div class="product_img">
            ...
            <div class="product_detail">
                <div class="product_name">
                    <p class="brand_name"><?php echo
                    $fetchDisplayDataQueryResult['brand_name']?></p>

                    <p class="product_nme"><?php echo
                    $fetchDisplayDataQueryResult['product_name']?></p>
                </div>
                <?php $priceProduct = $fetchDisplayDataQueryResult['discount_price'] ?>
                <div class="product_price">
                    <p>₹<?php echo $fetchDisplayDataQueryResult['discount_price']?><del>
                    ₹<?php echo $fetchDisplayDataQueryResult['price']?><del></p>
                </div>
                ...
                <?php
                    ...
                    <div class="product_buttons">
                        ...
                        <button name="buyNow" class="cert_x">Buy Now</button>
                       <input type="hidden" name="tab_name" value="<?php echo $tableName ?>">
